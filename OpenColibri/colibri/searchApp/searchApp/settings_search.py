...
DATABASES = {
    'default': {
        ...
        'NAME': 'searchApp.db', # Or path to database file if using sqlite3.
...
#
#HAYSTACK_SITECONF='searchApp.search_indexes'
...
ROOT_PATH = os.path.abspath(os.path.dirname(__file__ + '/../../colibri/'))
...
SECRET_KEY = 'dx6h6j=zl@^&amp;8yt03i*1yn^s^ho-r5c*za9z0c*4q_hkccaw(^'
