...
(function ($) {
     ...
     *
     * Allows a regular expression to be constructed to searchApp for
     * variable text.
     *
    ...
    var ColumnFilterWidgets = function (oDataTableSettings) {
        ...
        $.each(oDataTableSettings.aoColumns, function (i, oColumn) {
            ...
            var $WidgetElem = $('<div ' + 'id="widget_' + i + '" class="column-filter-widget"></div>');
        ...
        widget.$Select = $('<select></select>').change(function () {
            ...
            $TermLink = $('<a class="filter-term" href="#"></a>')
                ...
                .click(function () {
                    ...
                    widget.fnFilter();
                    //Update Charts
                    var mydata = widget.oDataTable.fnGetFilteredData();
