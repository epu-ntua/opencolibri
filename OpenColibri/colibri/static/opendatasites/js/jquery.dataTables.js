...
(/** @lends <global> */function ($, window, document, undefined) {
    ...
    var DataTable = function (oInit) {
         ...
         *  @param {object} oSettings dataTables settings object
         *  @param {object} oSearch searchApp information
        ...
        function _fnFilterComplete(oSettings, oInput, iForce) {
            ...
            /* Rebuild searchApp array 'offline' */
         ...
         *  @param {bool} bRegex treat searchApp string as a regular expression or not
        ...
        function _fnFilter(oSettings, sInput, iForce, bRegex, bSmart, bCaseInsensitive) {
            ...
            if (sInput.length <= 0) {
                ...
                /*
                 * We are starting a new searchApp or the new searchApp string is smaller
                ...
                if (oSettings.aiDisplay.length == oSettings.aiDisplayMaster.length ||
                    ...
                    /* Force a rebuild of the searchApp array */
                    _fnBuildSearchArray(oSettings, 1);

                    /* Search through all records to populate the searchApp array
                    ...
                    /* Using old searchApp array - refine it - do it this way for speed
                     * Don't have to searchApp the whole master array again
                     */
                    var iIndexCorrector = 0;
        ...
        /**
         * Create an array which can be quickly searchApp through
         *  @param {object} oSettings dataTables settings object
         ...
         *  @param {object} oSettings dataTables settings object
         *  @param {array} aData Row data array to use for the data to searchApp
         *  @memberof DataTable#oApi
         */
         ...
         *  @param {string} sSearch string to searchApp for
         *  @param {bool} bRegex treat as a regular expression or not
         *  @param {bool} bSmart perform smart filtering or not
         *  @param {bool} bCaseInsensitive Do case insenstive matching or not
        ...
        /**
         * Convert raw data into something that the user can searchApp on
         *  @param {string} sData data to be modified
         *  @param {string} sType data type
         *  @returns {string} searchApp string
         *  @memberof DataTable#oApi
         */
        ...
        this.fnDeleteRow = function (mTarget, fnCallBack, bRedraw) {
            ...
            /* Remove the target row from the searchApp array */
        ...
        this.fnUpdate = function (mData, mRow, iColumn, bRedraw, bAction) {
            ...
            /* Modify the searchApp index for this row (strictly this is likely not needed, since fnReDraw
             * will rebuild the searchApp array - however, the redraw might be disabled by the user)
             */
     ...
     * searchApp information for the global filter and individual column filters.
     *  @namespace
     */
    DataTable.models.oSearch = {
        ...
        /**
         * Flag to indicate if the searchApp term should be interpreted as a
    ...
    DataTable.defaults = {
         ...
         * the searchApp string will be treated as a regular expression, when false
         ...
         *    $(document).ready( function() {
		 *      $('#example').dataTable( {
		 *        "oSearch": {"sSearch": "Initial searchApp"}
		 *      } );
		 *    } )
         */
    ...
    DataTable.models.oSettings = {
        ...
        /**
         * Store the applied global searchApp information in case we want to force a
         * research or compare the old searchApp to a new one.
         * Note that this parameter will be set by the initialisation routine. To
         * set a default use {@link DataTable.defaults}.
         *  @namespace
         *  @extends DataTable.models.oSearch
        ...
        /**
         * Store the applied searchApp for each column - see
