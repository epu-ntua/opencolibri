(function (f, A) {
    ...
    z.prototype = {init: function (a, d) {
        ...
        if (!m && f)m = this.title = c.label(f), m.add(b);
        if (!e && i && s(i.type, o) !== -1)e = this.shape = c[g.shape.type](i.params), e.add(b);
        ...
        if (e)h = e instanceof f.Point ? "point" : e instanceof f.Series ? "series" : null, h === "point" ? (a.xValue = e.x, a.yValue = e.y, q = e.series) : h === "series" && (q = e), c.visibility !== q.group.visibility && c.attr({visibility: q.group.visibility});
        ...
        if (!isNaN(e) && !isNaN(h) && k(e) && k(h)) {
            ...
            c.bBox = null;
            if (!k(i))p = c.getBBox(), i = p.width;
            if (!k(t))p || (p = c.getBBox()), t = p.height;
            if (!k(v))v = n.center;
            if (!k(u))u = n.center;
            e -= i * v;
            h -= t * u;
        ...
        if (l(b)) {
            if (!l(d) || b !== c)this.linkedObject = a.get(b)
    ...
    r(w.prototype, {annotations: {add: function (a, d) {
        ...
        Object.prototype.toString.call(a) ===
            "[object Array]" || (a = [a]);
        for (e = a.length; e--;)f = new z(b, a[e]), c.push(f), f.render(d)
    }, redraw: function () {
