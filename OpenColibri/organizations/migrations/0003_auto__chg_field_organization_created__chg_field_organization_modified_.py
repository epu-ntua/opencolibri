...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.alter_column('organizations_organization', 'slug',
                        self.gf('django.db.models.SlugField')(max_length=100, blank=False, editable=True, unique=True))
        ...
        db.alter_column('organizations_organizationuser', 'modified',
                        self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'OrganizationOwner.created'
        db.alter_column('organizations_organizationowner', 'created',
                        self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'OrganizationOwner.modified'
        db.alter_column('organizations_organizationowner', 'modified',
                        self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Changing field 'Organization.created'
        db.alter_column('organizations_organization', 'created',
                        self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Organization.modified'
        db.alter_column('organizations_organization', 'modified',
                        self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Organization.slug'
        db.alter_column('organizations_organization', 'slug',
                        self.gf('django.db.models.fields.SlugField')(max_length=100, blank=False, editable=True,
                                                                     unique=True))

        # Changing field 'OrganizationUser.created'
        db.alter_column('organizations_organizationuser', 'created',
                        self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        'organizations.organization': {
            ...
            'slug': ('django.db.models.SlugField', [],
                     {'max_length': '100', 'blank': 'False', 'editable': 'True', 'unique': 'True'}),
            'users': ('django.db.models.fields.related.ManyToManyField', [],
                      {'to': "orm['auth.User']", 'through': "orm['organizations.OrganizationUser']",
                       'symmetrical': 'False'})
        },
        'organizations.organizationowner': {
            ...
            'modified': (
            'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'organization': ('django.db.models.fields.related.OneToOneField', [],
                             {'related_name': "'owner'", 'unique': 'True', 'to': "orm['organizations.Organization']"}),
            'organization_user': ('django.db.models.fields.related.OneToOneField', [],
                                  {'related_name': "'owned_organization'", 'unique': 'True',
                                   'to': "orm['organizations.OrganizationUser']"})
        },
        'organizations.organizationuser': {
            ...
            'organization': ('django.db.models.fields.related.ForeignKey', [],
                             {'related_name': "'organization_users'", 'to': "orm['organizations.Organization']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [],
                     {'related_name': "'organization_users'", 'to': "orm['auth.User']"})
        }
    }
